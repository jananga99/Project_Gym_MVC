<?php
$customer_arr = isset($_SESSION['data']) ? $_SESSION['data'] : array();
...
<body>
    ...
    <div class="container">
        ...
        <div class="d-flex flex-column bd-highlight mb-3">
            <form action=<?=BASE_DIR . "Customer/viewAll"?> method="POST">
        ...
        <table  class='table table-hover' style='color:white'>
            ...
            foreach ($customer_arr as $row) {
                ...
                <td>" . $row['Gender'] . "</td>
                <td><form action=" . BASE_DIR . "Customer/view/".$row['Email']." method='POST'>
            ...
            echo "<p>There are no customers available yet.</p>";
        }
        ?>
