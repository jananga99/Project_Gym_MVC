...
<body>
    ...
    <div class="container">
        ...
        <form action= <?=BASE_DIR . "Payment/viewPay"?> method='post'>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <label for="item_id">
                ...
                if (!($_SESSION['payment_data']['Payment_Type'] == PAYMENT_SESSION_CREATE))
                    echo "<input type='text' class='form-control' name='item_id' value={$_SESSION['payment_data']['Item_id']} readonly>";
                ?>
            </div>

            <input type="text" class="form-control" name='payment_type' value=<?php echo $_SESSION['payment_data']["Payment_Type"] ?> style="display:none" readonly>
